...
const UpdateUserForm = () => {
  ...
  const UpdateData = async (event) =>  {
    ...
    if(res.status === 422)
    {
      ...
      window.alert("update user successfull");
    ...
    <ThemeProvider theme={defaultTheme}>
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          <Box component="form" noValidate onSubmit={UpdateData} sx={{ mt: 3 }}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <CssTextField 
                  required
                  fullWidth
                  label="User ID whose detail we want to update"
                  id="id"
                  autoComplete="off"
                  name="id"
                  value={user.id}
        ...
        >
            <NavLink class="" to="/deleteUser"  style={{textDecoration:"none",margin:"10px auto"}} >Delete User Data</NavLink>
        </Box>
        <Box 
            sx={{  mb: 2 }}
          style={{
        ...
        >
            <NavLink class="" to="/addUser"  style={{textDecoration:"none",margin:"10px auto"}} >Add User Data</NavLink>
        </Box>
        <Box 
          style={{
            paddingBottom:"6px" , 
